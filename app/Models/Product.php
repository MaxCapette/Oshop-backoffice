...
class Product extends CoreModel
{
    ...
    public static function find($productId)
    {
        ...
        $sql = '
            SELECT `id`, `name`, `description`, `picture`, `price`,`rate`, `status`, `created_at`, `updated_at`
            FROM `product`
            WHERE id = ' . $productId;
    ...
    {
        $pdo = Database::getPDO();
        $sql = 'SELECT `id`, `name`, `description`, `picture`, `price`,`rate`, `status`, `created_at`, `updated_at` FROM `product`';
        $pdoStatement = $pdo->query($sql);
    ...
    public function update()
{
    ...
    // Ecriture de la requête UPDATE avec des paramètres liés
    $sql = "
        UPDATE `product`
        SET
            `name` = :name,
    ...
    // Execution de la requête de mise à jour avec les paramètres liés
    $queryIsSuccessful = $preparedQuery->execute([
        ':name' => $this->name,
        ':description' => $this->description,
        ':picture' => $this->picture,
